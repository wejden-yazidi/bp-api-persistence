...
@Document(collection = "commande_pointVente_partenaire_caisse_view")
public class CommandePointVentePartenaireCaisseView {
    ...
    private PartenaireBprice partenaireBprice;

    public CommandePointVentePartenaireCaisseView() {
    }
    ...
    public PartenaireBprice getPartenaireBprice() {
        return partenaireBprice;
    }

    public void setPartenaireBprice(PartenaireBprice partenaireBprice) {
        this.partenaireBprice = partenaireBprice;
    }
}
