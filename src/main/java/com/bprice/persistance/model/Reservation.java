...
public class Reservation {
	...
	private List<ClientPartenaire> ClientsCible;
	

	public Reservation() {
	}

	public Reservation(String idConsommateur, String idTable, String idSession, Date dateReseravation, Integer nbrPers,
	...
	public List<ClientPartenaire> getClientsCible() {
		return ClientsCible;
	}

	public void setClientsCible(List<ClientPartenaire> clientsCible) {
		ClientsCible = clientsCible;
	}
